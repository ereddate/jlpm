jlpm.config({
  help: {
		browser: "浏览器识别 \r\n jlpm.browser.firefox([true]); \r\n 参数：true 返回版本号 \r\n 返回 true|false",
		cache:"本地存储 localStorage 设置 \r\n jlpm.cache(key,value); \r\n 参数 value 为空，返回对应的值。key 为空，返回长度。key 为数字，返回索引对应的名称。全不为空，设置对应的值。",
		cacheRemove:"本地存储 localStorage 删除 \r\n jlpm.cacheRemove(key); \r\n 参数 key 为空，清空。不为空，删除指定项值。",
		device: "设备类型识别 \r\n jlpm.device.desktop([true]); \r\n 参数: true 返回设备模式32|64位 \r\n 返回 true|false",
		events: "简易事件 \r\n _$(selector).click(function(){});",
		os: "系统识别 \r\n jlpm.os.chromeos([true]); \r\n 参数：true 返回版本号 \r\n 返回 true|false",
		ver: "框架内部版本 \r\n jlpm.ver",
		ajax:{
			get:'ajax get方法 \r\n jlpm.Ajax([{data:selector, oninit:function(){console.log(data);return {status:true,info:"测试错误"};},...}]).get([""]); \r\n []内为可选参数',
			post:'ajax post方法 \r\n jlpm.Ajax([{data:selector, oninit:function(){console.log(data);return {status:true,info:"测试错误"};},...}]).post([""]); \r\n []内为可选参数'
		},
		...
		ua: "取设备、浏览器等信息 \r\n jlpm.ua().browser;",  //20130416 因提供外部jlpmUa模块，现将info方法更名为ua。
		...
		//isObject: "是否为对象 \r\n jlpm.isObject(value); \r\n 返回 true|false",  //20130416取消此方法
		isObjectList: "是否为对象列表 \r\n jlpm.isObjectList(value); \r\n 返回 true|false",
		isOnff: "HTML5检测是否在线 \r\n jlpm.isOnff(); \r\n 返回 true|false",
		isPO: "是否为原型的对象 \r\n jlpm.isPO(value); \r\n 返回 true|false",
		isSingle: "是否为单一对象 \r\n jlpm.isSingle(value); \r\n 返回 true|false",
		isString: "是否为字符串 \r\n jlpm.isString(value); \r\n 返回 true|false",
		...
		//orderExec: "顺序执行",  //单独提出为模块文件，20130415
		...
		right: "获取对象的right值 \r\n jlpm.right(selector);",
		stringify:"序列化一个对象 \r\n jlpm.stringify(object); \r\n 返回序列化后的string，无法序列化的返回null",  //20130418 增加
		...
		top: "获取对象的top值 \r\n _$(selector).top();",
		trim: "删除字符串的空格 \r\n jlpm.trim(string,位置);",
		//type: "返回对象类型 \r\n jlpm.type(object);", //20130416取消此方法
