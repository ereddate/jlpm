_$().config({
  help: {
		...
		get:'ajax get方法 \r\n _$(selector).get(url[, data, callback, options]); \r\n []内为可选参数',
		post:'ajax post方法 \r\n _$(selector).post(url[, data, callback, options]); \r\n []内为可选参数',
		...
		ua: "取设备、浏览器等信息 \r\n _$().ua().browser;",  //20130416 因提供外部jlpmUa模块，现将info方法更名为ua。
